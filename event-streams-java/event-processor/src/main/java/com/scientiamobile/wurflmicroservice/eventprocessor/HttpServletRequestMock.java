...
public class HttpServletRequestMock implements HttpServletRequest {
    ...
    public HttpServletRequestMock(Map<String,String> headers){
        headers.keySet().forEach((String key) -> {
            _headers.put(key.toLowerCase(), headers.get(key));
        });
    }
